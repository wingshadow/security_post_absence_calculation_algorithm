...
public class Test12Scenes {
    ...
    private static void scene1(List<ClassGroupDetailRespDTO> shifts, LocalDate date) {
        ...
        Map<String, Long> result = TimeEngine.calc(shifts, Arrays.asList(d1, d2));
        printResult(result);
    }
    ...
    private static void scene2(List<ClassGroupDetailRespDTO> shifts, LocalDate date) {
        ...
        Map<String, Long> result = TimeEngine.calc(shifts, Arrays.asList(d1));
        printResult(result);
    }

    // 场景3：无打卡
    private static void scene3(List<ClassGroupDetailRespDTO> shifts, LocalDate date) {
        Map<String, Long> result = TimeEngine.calc(shifts, Arrays.asList());
        printResult(result);
    }
    ...
    private static void scene6(List<ClassGroupDetailRespDTO> shifts, LocalDate date) {
        ...
        Map<String, Long> result = TimeEngine.calc(shifts, Arrays.asList(d1, d2, d3));
        printResult(result);
    }
